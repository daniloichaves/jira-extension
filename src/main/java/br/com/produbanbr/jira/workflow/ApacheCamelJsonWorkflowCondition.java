package br.com.produbanbr.jira.workflow;
...
public class ApacheCamelJsonWorkflowCondition extends AbstractJiraCondition
{
    private static final Logger log = LoggerFactory.getLogger(ApacheCamelJsonWorkflowCondition.class);
    ...
    public ApacheCamelJsonWorkflowCondition(SearchProvider searchProvider) {
